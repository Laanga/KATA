...
function MetricCard({
    ...
    return (
        <FadeIn delay={delay}>
            <div
                className="liquid-glass-soft group relative rounded-2xl border border-white/10 p-3 sm:p-4 md:p-5 transition-all duration-300 hover:-translate-y-0.5 hover:border-white/20"
                style={{
